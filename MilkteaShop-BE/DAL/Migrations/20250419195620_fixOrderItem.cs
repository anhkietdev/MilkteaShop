...
namespace DAL.Migrations
{
    ...
    public partial class fixOrderItem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoryExtraMappings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MainCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryExtraMappings", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CategoryExtraMappings_Categories_ExtraCategoryId",
                        column: x => x.ExtraCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CategoryExtraMappings_Categories_MainCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryExtraMappings_ExtraCategoryId",
                table: "CategoryExtraMappings",
                column: "ExtraCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryExtraMappings_MainCategoryId",
                table: "CategoryExtraMappings",
